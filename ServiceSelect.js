      ...
      <ImageBackground style={{ width: '100%', height: '100%' }} source={'https://static.wixstatic.com/media/nsplsh_c7567a7e7bf34da784e174828d5c9298~mv2.jpg/v1/fill/w_1349,h_608,al_c,q_85,usm_0.66_1.00_0.01,enc_auto/nsplsh_c7567a7e7bf34da784e174828d5c9298~mv2.jpg'}>
        <View style={{ display: 'flex', flexDirection: 'column', justifyContent: 'center', alignItems: 'center', height: '100%' }}>
          ...
          <Card style={{ padding: '40px', borderRadius: '20px', width: '90%', marginBottom: '20px', }}>
            <View style={{ borderColor: '#301934', borderWidth: 2, padding: '10px' }}>
            ...
            <View style={{ display: 'flex', flexDirection: 'row', justifyContent: 'center' }}>
              <Button style={{marginTop: '-20px', width: '60%', borderColor: '#301934', borderWidth: 2, backgroundColor: "#FFFFFF"  }} mode="outlined" color='#301934' onPress={() => move(cat[3])}>{cat[3]?.name}</Button>
            </View>
          </Card>
          <Card style={{ padding: '40px', borderRadius: '20px', width: '90%', marginBottom: '20px' }}>
            <View style={{ borderColor: '#301934', borderWidth: 2, padding: '10px' }}>
            ...
            <View style={{ display: 'flex', flexDirection: 'row', justifyContent: 'center' }}>
              <Button style={{ marginTop: '-20px', width: '60%', borderColor: '#301934', borderWidth: 2, backgroundColor: "#FFFFFF" }} mode="outlined" color='#301934' onPress={() => move(cat[0])}>{cat[0]?.name}</Button>
            </View>
          </Card>
          <Card style={{ padding: '40px', borderRadius: '20px', width: '90%', marginBottom: '20px' }}>
            <View style={{ borderColor: '#301934', borderWidth: 2, padding: '10px' }}>
            ...
            <View style={{ display: 'flex', flexDirection: 'row', justifyContent: 'center' }}>
              ...
              <Button style={{marginTop: '-20px', width: '60%', borderColor: '#301934', borderWidth: 2, backgroundColor: "#FFFFFF"  }} mode="outlined" color='#301934' onPress={() => move(cat[2])}>{cat[2]?.name}</Button>
            </View>
          </Card>
          <Card style={{ padding: '40px', borderRadius: '20px', width: '90%', marginBottom: '20px' }}>
            <View style={{ borderColor: '#301934', borderWidth: 2, padding: '10px' }}>
            ...
            <View style={{ display: 'flex', flexDirection: 'row', justifyContent: 'center' }}>
              <Button style={{ marginTop: '-20px', width: '60%', borderColor: '#301934', borderWidth: 2, backgroundColor: "#FFFFFF" }} mode="outlined" color='#301934' onPress={() => move(cat[1])}>{cat[1]?.name}</Button>
            </View>
          </Card>
