        ...
        <View style={{ display: 'flex', flexDirection: 'column', justifyContent: 'center', alignItems: 'center', height: '100%' }}>
          ...
          <Card style={{ padding: '40px', borderRadius: '20px', width: '90%', marginBottom: '20px', }}>
            ...
            <View style={{ display: 'flex', flexDirection: 'row', justifyContent: 'center' }}>
              <Button style={{marginTop: '-20px', width: '60%', borderColor: '#301934', borderWidth: 2, backgroundColor: "#FFFFFF"  }} mode="outlined" color='#301934' onPress={() => move()}>Salon</Button>
            </View>
          </Card>
          <Card style={{ padding: '40px', borderRadius: '20px', width: '90%', marginBottom: '20px' }}>
            <View style={{ borderColor: '#301934', borderWidth: 2, padding: '10px' }}>
            ...
            <View style={{ display: 'flex', flexDirection: 'row', justifyContent: 'center' }}>
              <Button style={{ marginTop: '-20px', width: '60%', borderColor: '#301934', borderWidth: 2, backgroundColor: "#FFFFFF" }} mode="outlined" color='#301934' onPress={() => move()}>Aesthetics</Button>
            </View>
          </Card>
          <Card style={{ padding: '40px', borderRadius: '20px', width: '90%', marginBottom: '20px' }}>
            <View style={{ borderColor: '#301934', borderWidth: 2, padding: '10px' }}>
            ...
            <View style={{ display: 'flex', flexDirection: 'row', justifyContent: 'center' }}>
              ...
              <Button style={{marginTop: '-20px', width: '60%', borderColor: '#301934', borderWidth: 2, backgroundColor: "#FFFFFF"  }} mode="outlined" color='#301934' onPress={() => move()}>Fitness</Button>
            </View>
          </Card>
          <Card style={{ padding: '40px', borderRadius: '20px', width: '90%', marginBottom: '20px' }}>
            <View style={{ borderColor: '#301934', borderWidth: 2, padding: '10px' }}>
            ...
            <View style={{ display: 'flex', flexDirection: 'row', justifyContent: 'center' }}>
              <Button style={{ marginTop: '-20px', width: '60%', borderColor: '#301934', borderWidth: 2, backgroundColor: "#FFFFFF" }} mode="outlined" color='#301934' onPress={() => move()}>Photography</Button>
            </View>
          </Card>
