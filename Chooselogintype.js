  ...
  return (
    <View style={{ display: 'flex', flexDirection: 'column', justifyContent: 'center', alignItems: 'center', height: '100%', backgroundColor: '#9c8cbc' }}>
        <Card style={{ padding: '40px', borderRadius: '20px', width: '90%' }}>
          ...
          <Button style={{ marginBottom: '30px' }} mode="contained"  onPress={()=>move()}>Client Login</Button>
          <Button style={{ marginBottom: '30px' }} mode="contained"  onPress={()=>moves()}>Business Login</Button>
        </Card>
    </View>
  );
}
