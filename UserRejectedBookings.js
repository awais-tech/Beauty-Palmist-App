        ...
        <SafeAreaView style={{}}>
            <View style={{ display: 'flex', flexDirection: 'column', justifyContent: 'center', alignItems: 'center', height: '100%', backgroundColor: '#ffe4e4' }}>
                <Card style={{ padding: '40px', borderRadius: '20px', width: '90%', marginTop: '30px', marginBottom: '30px' }}>
                    ...
                    />
                    <List.Section>
                        <List.Subheader>All Rejected Bookings</List.Subheader>
                        <List.Item
                            left={() => <View>
                            ...
                            right={() => <View>
                                <Button mode='contained' style={{ marginBottom: '5px', backgroundColor: '#FF69B4' }}>View Message</Button>
                                <Button mode='contained' style={{backgroundColor: '#FF69B4'}}>Re-Request</Button>
                            </View>}
                        />
                        <List.Item
                            left={() => <View>
