                ...
                <Card style={{ padding: '40px', borderRadius: '20px', width: '90%', marginTop: '30px', marginBottom: '30px' }}>
                    ...
                    <List.Section>
                        ...
                        <List.Item
                            ...
                            right={() => <View>
                                <Button mode='contained' style={{ marginBottom: '5px', backgroundColor: '#FF69B4' }}>Give Feedback</Button>
                                <Button mode='contained' style={{backgroundColor: '#FF69B4'}}>Book Again</Button>
                            </View>}
                        />
                        <List.Item
                            left={() => <View>
